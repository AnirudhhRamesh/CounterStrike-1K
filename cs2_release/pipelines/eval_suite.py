...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            "Manifest split used for retrieval pair construction and corruption packs. "
            "Defaults to 'test' for paper reproduction. Set to 'train' when running "
            "against the public sample repo, which only ships split=train rows."
        ),
    )
